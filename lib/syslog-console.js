     ...
     * @return {Integer}
     */
    SyslogConsole.prototype.timeStartAlert = function(mMessage) {
        if (mMessage !== undefined) {
            this.alert(mMessage);
        }
     ...
     * @return {Integer}
     */
    SyslogConsole.prototype.timeStopAlert = function(iStart, mMessage) {
        var iTime = this._endTimer(iStart, mMessage);
        this.alert(mMessage);
        return iTime;
    };
